...
public class GlobalExceptionHandler {
    ...
    public ApiResponse<?> handleNotFound(OrderNotFoundException ex) {
        return ApiResponse.error("ORDER_NOT_FOUND", ex.getMessage());
    }

    @ExceptionHandler(OrderAccessDeniedException.class)
    @ResponseStatus(HttpStatus.FORBIDDEN)
    public ApiResponse<?> handleAccessDenied(OrderAccessDeniedException ex) {
        return ApiResponse.error("ACCESS_DENIED", ex.getMessage());
    }

    @ExceptionHandler(InvalidOrderStateException.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public ApiResponse<?> handleInvalidState(InvalidOrderStateException ex) {
